        ...
        <div class="body">
            <div class="pb-member-vip">
                ...
                <form action="{{$__msRoot}}api/member_vip/buy" method="post" data-ajax-form>
                    ...
                    <div
                        class="lg:tw-px-12 lg:tw-text-left tw-text-center tw-py-4 vip-bg tw-rounded-xl margin-bottom tw-flex lg:tw-flex-row tw-flex-col tw-items-start">
                    ...
                    <div class="tw-rounded-xl vip-bg vip-content-list tw-py-3 lg:tw-px-6">
                        @foreach($memberVips as $memberVip)
                            @if(!$memberVip['isDefault'])
